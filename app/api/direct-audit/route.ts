    ...
    if (hasOpenAi) {
      try {
        ...
        const prompt = [
          ...
          'The five scored pillars are already deterministic: Website + Ordering, Reputation + Local Presence, Customer Retention, Customer Engagement, Measurement + Growth. Do not recompute or contradict the scores.',
